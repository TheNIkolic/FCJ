...
private let _fcjDefaultRedColor: UIColor = UIColor(red: 254.0 / 255.0, green: 3.0 / 255.0, blue: 7.0 / 255.0, alpha: 1.0)
...
extension UIColor {
    ...
    public static var fcjDefaultRed:                    UIColor { return _fcjDefaultRedColor }
}
